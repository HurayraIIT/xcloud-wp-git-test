...
class LicenseManager {
    ...
    public function get_license_data() {
        ...
        $_license_data   = (array) get_option( "{$this->db_prefix}_license_data", [] );
    ...
    public function activate( $args = [] ) {
        ...
        update_option( "{$this->db_prefix}_license_data", $response, 'no' );
    ...
    public function deactivate( $args = [] ) {
        ...
        delete_option( "{$this->db_prefix}_license_data" );
