                                ...
                                <div class="dynamic-amount-section-inner has-text-white p-6">
                                    <div class="pt-3 pb-3">
                                        ...
                                        <p class="is-size-6-fix pt-2 dynamic-amount-section-subtitle bp-dynamic-amount-section-amount">
                                            <?php _e(sprintf("%s <a class=' %s ' href='%s'>%s</a>", $layout_form_transaction_details_product_title, $layout_dynamic_payment_hide_show ,$product_permalink, $product_name), 'better-payment'); ?><br>
                                        ...
                                        <h4 class="is-size-2-fix pt-5 dynamic-amount-section-amount bp-dynamic-amount-section-amount-summary"><?php _e(sprintf('%s<span class="bp-transaction-details-amount-text">%s</span>%s', esc_html( $layout_form_currency_left ), '' !== $product_price ? floatval($product_price) : '', esc_html( $layout_form_currency_right ) ), 'better-payment'); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="form-content-section-fields">
                                            <div class="field-payment_method">
                                                <div class="control bp-radio-box columns">
                                                    ...
                                                    <label class="radio pr-6 mb-5 payment-method-checkbox active column has-text-centered">
                                                    ...
                                                    <label class="radio mb-5 payment-method-checkbox <?php echo empty( $settings[ 'better_payment_form_paypal_enable' ] ) ? esc_attr('active') : '' ?> column has-text-centered">
