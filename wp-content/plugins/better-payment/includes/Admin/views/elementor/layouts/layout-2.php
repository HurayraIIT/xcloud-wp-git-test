                            ...
                            <div class="dynamic-amount-section has-background-link  ">
                                <div class="dynamic-amount-section-inner has-text-white p-6">
                                    <div class="pt-3 pb-3">
                                        ...
                                        <h4 class="is-size-2-fix pt-5 bp-dynamic-amount-section-amount-summary"><?php _e(sprintf('%s<span class="bp-transaction-details-amount-text">%s</span>%s', esc_html( $layout_form_currency_left ), '' !== $product_price ? floatval($product_price) : '', esc_html( $layout_form_currency_right ) ), 'better-payment'); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
