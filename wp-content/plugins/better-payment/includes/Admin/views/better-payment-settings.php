                ...
                <div class="bp-col-lg-9">
                    <div class="bp-tabs">
                        <ul class="tab__menu">
                            ...
                            <?php if(!class_exists('\Better_Payment_Pro')): ?>
                            <li class="tab__list">
                            ...
                            <?php if(class_exists('\Better_Payment_Pro')): ?>
                            <li class="tab__list">
                                <a href="#license" class="tab__link" data-id="license"><i class="bp-icon bp-license"></i><?php _e('License', 'better-payment'); ?></a>
                            </li>
                            <?php endif; ?>
                        </ul>
                                                ...
                                                <div class="payment__options">
                                                    <div class="payment__option">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php _e('Live mode allows you to process real transactions. It just requires PayPal business email to accept real payments.', 'better-payment'); ?></p>
                                                        </div>
                                                        <div class="active__status">
                                                            <label class="bp-switch">
                                                    ...
                                                    <div class="payment__option bp-paypal-key bp-paypal-test-key <?php echo $better_payment_settings_payment_paypal_live ? 'bp-d-none' : 'bp-d-block' ?> ">
                                                        <div class="payment__option__content">
                                                            ...
                                                            <p><?php _e('PayPal test/sandbox client id is required to do refund via PayPal. For more help visit', 'better-payment'); ?> <a class="color__themeColor" target="_blank" rel="nofollow" href="https://developer.paypal.com/developer/applications">https://developer.paypal.com/developer/applications</a>.</p>
                                                        </div>
                                                        <div class="active__status input__wrap">
