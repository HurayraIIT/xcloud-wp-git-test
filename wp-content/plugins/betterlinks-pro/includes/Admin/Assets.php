    ...
    public function plugin_scripts($hook)
    {
        if (\BetterLinks\Helper::plugin_page_hook_suffix($hook)) {
            ...
            wp_enqueue_script(
                ...
                "https://www.googletagmanager.com/gtag/js?id=G-9GLQ7H4QPG",
                [],
                $dependencies['version'],
                true
            );
            ...
            wp_localize_script('betterlinkspro-admin-core', 'betterLinksProGlobal', [
                ...
                'user_can_manage_autolinks' => \BetterLinksPro\Helper::current_user_can_do('manageAutoliks', $user, $user_permission),
