...
class Admin
{
    ...
    public function add_new_menu_item($items)
    {
        ...
        $can_current_user_manage_autolinks = \BetterLinksPro\Helper::current_user_can_do('manageAutoliks', $user, $user_permission);
        foreach ($items as $key => $item) {
            $sub_menu[$key] = $item;
            if ($key === 'betterlinks' && $can_current_user_manage_autolinks ) { 
