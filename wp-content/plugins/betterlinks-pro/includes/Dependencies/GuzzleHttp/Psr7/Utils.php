...
namespace BetterLinksPro\Dependencies\GuzzleHttp\Psr7;

use BetterLinksPro\Dependencies\Psr\Http\Message\RequestInterface;
use BetterLinksPro\Dependencies\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `BetterLinksPro\Dependencies\Psr\Http\Message\StreamInterface`: Returns the value as-is.
