...
class Cron
{
    public static function init()
    {
        ...
        add_action('betterlinkspro/send_google_analytics_data', array($self, 'send_google_analytics_data'), 10, 4);
    ...
    public function send_google_analytics_data($data, $page_url, $ga_tracking_code, $ga4_api_secret)
    {
        if ($ga_tracking_code) {
            $analytic = new \BetterLinksPro\Analytics\GoogleAnalytics();
            $analytic->ga_send_pageview(get_site_url(), $page_url, $data['link_slug'], $ga_tracking_code, $ga4_api_secret);
        }
    }
